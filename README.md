...
Our security policy is located [here](https://github.com/ministryofjustice/hmpps-dps-reconciliation/security/policy).
...
## Renaming from HMPPS Dps Reconciliation - github Actions
...
```bash
docker compose pull && docker compose up --scale hmpps-dps-reconciliation=0
```
