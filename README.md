...
[![Ministry of Justice Repository Compliance Badge](https://github-community.service.justice.gov.uk/repository-standards/api/hmpps-dps-reconciliation/badge?style=flat)](https://github-community.service.justice.gov.uk/repository-standards/hmpps-dps-reconciliation)
...
A booking.moved occurs:

- OFFENDER_BOOKING-REASSIGNED
- booking.moved domain event
- *possible* domain release (of the other, "from" prisoner)
- *possible* domain receive (READMISSION_SWITCH_BOOKING of the "to" prisoner)
